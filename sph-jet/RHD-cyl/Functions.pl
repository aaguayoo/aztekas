...
print Matrix "         f = 2.0;\n";
print Matrix "\n";
print Matrix "         while (fabs(f) > 0.0000001)\n";
print Matrix "         {\n";
print Matrix "            h    = 1.0 + (K / (K - 1.0)) * theta_0;\n";
print Matrix "            lor  = sqrt(1.0 + SS / pow(D*h,2.0));\n";
print Matrix "            derh = K / (K - 1.0);\n";
print Matrix "\n";
print Matrix "            f    = h * lor - (theta_0 / lor) - (t / D) - 1.0;\n";
print Matrix "            derf = (1.0 / lor) * (derh - 1.0 - theta_0 * ((lor * lor - 1.0) / (lor * lor)) * (derh / h));\n";
print Matrix "\n";
print Matrix "            theta = theta_0 - f / derf;\n";
print Matrix "            theta_0 = theta;\n";
print Matrix "         }\n";
print Matrix "\n";
print Matrix "         h   = 1.0 + (K / (K - 1.0)) * theta_0;\n";
print Matrix "         lor  = sqrt(1.0 + SS / pow(D*h,2.0));\n";
...
print Matrix "         a[c1(1,i)] = D*h*lor - t - D;\n";
...
print Matrix "            f = 2.0;\n";
print Matrix "\n"; 
print Matrix "            while (fabs(f) > 0.000001)\n";
print Matrix "            {\n";
print Matrix "               h    = 1.0 + (K / (K - 1.0)) * theta_0;\n";
print Matrix "               lor  = sqrt(1.0 + SS / pow(D*h,2.0));\n";
print Matrix "               derh = K / (K - 1.0);\n";
...
print Matrix "            }\n";
print Matrix "\n";
print Matrix "            h   = 1.0 + (K / (K - 1.0)) * theta;\n";
print Matrix "            lor  = sqrt(1.0 + SS / pow(D*h,2.0));\n";
print Matrix "\n";
print Matrix "            a[c2(0,i,j)] = D / lor;\n";
print Matrix "            a[c2(1,i,j)] = D*h*lor - t - D;\n";
...
print Matrix "               a[c3(1,i,j,k)] = D*h*lor - t - D;\n";
