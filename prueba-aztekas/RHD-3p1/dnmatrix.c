...
double funct_Dn(double *a, double *uu)
{
   int i;
   ...
   for(i = 0; i <= 2; i++)
   {
      if(i == 0)
      {
         a[i] = ((v*O-K*p*v)*fabs(O)+O*sqrt(((K*p*pow(x1,2.0)*pow(v,2.0)-K*p*pow(x1,2.0))*pow(w,2.0)+K*p*pow(v,4.0)+(K*p*pow(u,2.0)-2*K*p)*pow(v,2.0)-K*p*pow(u,2.0)+K*p)*O+pow(K,2.0)*pow(p,2.0)*pow(x1,4.0)*pow(w,4.0)+(pow(K,2.0)*pow(p,2.0)*pow(x1,2.0)*pow(v,2.0)+2*pow(K,2.0)*pow(p,2.0)*pow(x1,2.0)*pow(u,2.0)-pow(K,2.0)*pow(p,2.0)*pow(x1,2.0))*pow(w,2.0)+pow(K,2.0)*pow(p,2.0)*pow(u,2.0)*pow(v,2.0)+pow(K,2.0)*pow(p,2.0)*pow(u,4.0)-pow(K,2.0)*pow(p,2.0)*pow(u,2.0)))/((O-K*p*pow(x1,2.0)*pow(w,2.0)-K*p*pow(v,2.0)-K*p*pow(u,2.0))*fabs(O));
      }
      else if(i == 1)
      {
         a[i] = -((K*p*v-v*O)*fabs(O)+O*sqrt(((K*p*pow(x1,2.0)*pow(v,2.0)-K*p*pow(x1,2.0))*pow(w,2.0)+K*p*pow(v,4.0)+(K*p*pow(u,2.0)-2*K*p)*pow(v,2.0)-K*p*pow(u,2.0)+K*p)*O+pow(K,2.0)*pow(p,2.0)*pow(x1,4.0)*pow(w,4.0)+(pow(K,2.0)*pow(p,2.0)*pow(x1,2.0)*pow(v,2.0)+2*pow(K,2.0)*pow(p,2.0)*pow(x1,2.0)*pow(u,2.0)-pow(K,2.0)*pow(p,2.0)*pow(x1,2.0))*pow(w,2.0)+pow(K,2.0)*pow(p,2.0)*pow(u,2.0)*pow(v,2.0)+pow(K,2.0)*pow(p,2.0)*pow(u,4.0)-pow(K,2.0)*pow(p,2.0)*pow(u,2.0)))/((O-K*p*pow(x1,2.0)*pow(w,2.0)-K*p*pow(v,2.0)-K*p*pow(u,2.0))*fabs(O));
      }
      else if(i == 2)
      {
         a[i] = v;
