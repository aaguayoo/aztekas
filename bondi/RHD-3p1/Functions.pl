...
print Matrix "double funct_Dm(double *a, double *uu);\n";
print Matrix "double funct_Dn(double *a, double *uu);\n";
print Matrix "double funct_Do(double *a, double *uu);\n";
close(Matrix);

open(Matrix, ">../Headers/vector.h");
print Matrix "double funct_Q(double *a, double *uu);\n";
print Matrix "double funct_F(double *a, double *uu);\n";
print Matrix "double funct_G(double *a, double *uu);\n";
print Matrix "double funct_H(double *a, double *uu);\n";
print Matrix "double funct_S(double *a, double *uu);\n";
close(Matrix);
...
print Matrix "      u = 0.9;\n";
print Matrix "   }\n";
print Matrix "   else if(v >= 1)\n";
print Matrix "   {\n";
print Matrix "      v = 0.9;\n";
print Matrix "   }\n";
print Matrix "   else if(w >= 1)\n";
print Matrix "   {\n";
print Matrix "      w = 0.9;\n";
print Matrix "   }\n";
print Matrix "    \n";
