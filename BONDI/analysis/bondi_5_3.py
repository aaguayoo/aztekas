...
#######################################################
#
# Compare Bondi analytic solution for gamma = 5/3
...
plt.savefig('bondi_5_3_velocity.png', bbox_inches='tight', pad_inches=0.0,dpi=200)
...
plt.savefig('bondi_5_3_density.png', bbox_inches='tight', pad_inches=0.0,dpi=200)
